...
import '../assets/css/InvestorRegistration.css'; // 🔥 Custom styles for InvestorRegistration
      ...
      <div className="row justify-content-center">
        <div className="col-12 col-lg-10">
          <motion.form
            ...
            className="inv-form fs-5 rounded-4 shadow-lg"
          ...
          >
            ...
            <div className="row mb-3">
              ...
              <div className="col-md-6">
                ...
                <input type="date" className="form-control" id="regDate" value={regdate} onChange={(e) => setRegdate(e.target.value)} />
              </div>
            </div>
